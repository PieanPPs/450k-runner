...
const rules = [
  { icon: '📏', label: 'ระยะขั้นต่ำ', value: '1.5 km ต่อครั้ง' },
  { icon: '⏱️', label: 'เวลาขั้นต่ำ', value: '20 นาที ต่อครั้ง' },
  { icon: '🚀', label: 'ความเร็วสูงสุด', value: '≤ 17 นาที/km (เร็วกว่า = ไม่นับ)' },
  { icon: '🐢', label: 'ความเร็วต่ำสุด', value: '≥ 3.5 นาที/km (ช้ากว่า = ไม่นับ)' },
];
        ...
        <div style={{
          ...
          <div style={{ marginTop: 14, padding: '10px 14px', background: 'rgba(6,182,212,0.08)', borderRadius: 10, borderLeft: '3px solid #06b6d4' }}>
            <span style={{ color: '#06b6d4', fontSize: 12 }}>
              ✅ รับทั้ง <strong>วิ่ง</strong> และ <strong>เดินเร็ว</strong> — ไม่นับปั่นจักรยาน, ขับรถ, หรือกิจกรรมที่เปิดทิ้งไว้
            </span>
          </div>
        </div>
