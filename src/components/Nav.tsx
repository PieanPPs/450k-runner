  ...
  return (
    <>
      ...
      <div className="nav-mobile" style={{
        ...
        <div style={{ padding: '12px 24px 20px', display: 'flex', flexDirection: 'column', gap: 0 }}>
          {links.map(l => (
            <a key={l.href} href={l.href}
              onClick={() => setMenuOpen(false)}
              style={{ color: t.text, fontSize: 15, fontWeight: 500, textDecoration: 'none', padding: '12px 0', borderBottom: `1px solid ${t.cardBorder}` }}
            >{l.label}</a>
          ))}
